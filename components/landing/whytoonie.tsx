...
export default function WhyToonie() {
  ...
  return (
    <div className="container bg-black text-white overflow-hidden mt-[200px]">
      ...
      <p className={`max-w-[600px] px-2 font-bold clear-both text-[55px] z-10 mb-[10px] text-white duration-1000 ease-in-out ${
        ...
        <ul className="space-y-1 md:space-y-1 mt-[30px]">
          {features.map((feature, index) => (
            <li
              ...
              className="w-full py-8 px-4 flex items-center cursor-pointer transition duration-300 hover:bg-black"
            >
